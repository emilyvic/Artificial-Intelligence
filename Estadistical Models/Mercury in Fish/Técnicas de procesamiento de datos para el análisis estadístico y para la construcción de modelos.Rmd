...
La contaminación por mercurio de peces en el agua dulce comestibles es una amenaza directa contra nuestra salud. Se llevó a cabo un estudio reciente en 53 lagos de Florida con el fin de examinar los factores que influían en el nivel de contaminación por mercurio. Las variables que se midieron se encuentran en mercurio.csv y el objetivo principal es hallar cuáles de estas variables son los factores más determinantes para las altas concentraciones de mercurio en los peces de los lagos de Florida, los cuales a su vez están provocando esta contaminación medioambiental. Subsecuentemente, para poder abordar esta problemática, se hizo uso de varias herramientas estadísticas vistas durante el móduo 1 de la concentración Inteligencia Artificial Avanzada para la Ciencia de Datos. Principalmente, se aplicó una regresión lineal múltiple la cuál sirvió para evaluar el efecto que tienen las variables propuestas sobre la concentración promedio de mercurio en los peces a través de la construcción de un modelo, el cuál a su vez fue validado por pruebas de hipótesis. En segunda instancia, se procedió a aplicar un análisis de ANOVA para verificar si el grupo de peces (ya sea jóvenes o adultos) influye en la concentración de mercurio de los lagos.

Los principales resultados a los que se llegaron fueron:

* El mejor modelo lineal múltiple Concentración media de mercurio en los peces de los lagos de Florida = 0.964X11 + 0.002X8 es capaz de explicar el 92.32% de la variabilidad observada en la concentración media de mercurio.
* Los factores principales que más influyen en el nivel de contaminación por mercurio en los peces de los lagos de Florida son: Cantidad de peces en el lago (variable predictora X8) y Estimación de la concentración de mercurio (variable predictora X11).

* Los factores de alcalinidad (X3), clorofila (X6) y calcio (X5) si tienen un nivel de influencia medio sobre la concentración de mercurio de los peces (X7).

*El grupo de peces por edades no es un factor significativo para la determinación de la concentración de mercurio en los lagos.
...
par(mfrow=c(1,1)) #Matriz de gráficos de 12x2
